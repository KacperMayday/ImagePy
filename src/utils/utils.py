...
from src.utils.constants import FILE_TYPES, MAX_INTENSITY_LEVEL, ColourEnum
...
class ColourIterator:
    def __init__(
        self,
        starting_colour_name: str = "black",
        colour_diff: int = 1,
        ...
        match starting_colour_name:
            ...
            case ColourEnum.RED:
                ...
                self.iter_func = lambda colours: [
                    colours[0] + colour_diff,
                    colours[1],
                    colours[2],
                ]
